...
export default function Index() {
  ...
  return (
    <>
                ...
                <div className="w-full   mr-auto ml-auto mt-8">
                  ...
                  {cricketMatchPredictions.map(item => (
                    ...
                    <div key={item.id} className="my-4 w-full lg:w-4/12 px-4">
                        ...
                        <div className={ Moment(item.date).isSame(Moment(), 'day')? 'bg-blue-500   shadow-lg  p-8':'bg-gray-700   shadow-lg  p-8'} >
      ...
      <section className="pb-12 relative bg-gray-100">
        ...
        <div className="container mx-auto">
            ...
            {items.map(item => (
              ...
              <div key={item.id} className="my-4 w-full lg:w-4/12 px-4">
                <div className="relative flex flex-col min-w-0 break-words bg-white w-full  shadow-lg  bg-blue-500">
                  <img
                    alt="..."
                  ...
                  />
                  <div className='p-4'>
                    <a href={'https://www.cricdiction.com/'+item.slug } >
      ...
      <section className="mt-14 md:mt-14 pb-40  bg-gray-100">
