                ...
                <div className="container bg-white mx-auto p-8 ">
                    <div className="flex flex-wrap  py-4">
                        ...
                        <div className="w-full md:w-6/12 lg:w-6/12 xl:w-6/12 lg:text-right md:text-right sm:text-center ">
                            <a href={'https://www.facebook.com/sharer.php?u=https://www.cricdiction.com/'+params.slug} >
                                <button
                            ...
                            <a href={'https://twitter.com/share?url=https://www.cricdiction.com/'+params.slug}  >
                            <button
                            ...
                            <a href={'https://pinterest.com/pin/create/button/?url=https://www.cricdiction.com/'+params.slug}  >
                            <button
                            ...
                            <a href={'mailto:?body=https://www.cricdiction.com/'+params.slug}  >
                            <button
